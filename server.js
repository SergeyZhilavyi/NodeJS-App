...
// Для того, чтобы каждый раз вручную не перезапускать сервер,  есть такой пакет nodemon, мы его уже установили
// Чтобы это всё было автоматизированно - в package.json,  в scripts сделали следующие изменения:
/*
    "scripts": {
